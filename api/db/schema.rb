...
ActiveRecord::Schema.define(version: 2021_12_12_060021) do

  create_table "ipads", options: "ENGINE=InnoDB DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "product_id"
    t.float "screen_size"
    t.string "chip"
